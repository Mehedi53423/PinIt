...
import { EditorSelection, EditorChange, EditorChanges, EditableAPI, InvalidValueResolution, PatchObservable, PortableTextSlateEditor } from '../types/editor';
...
export declare class PortableTextEditor extends React.Component<PortableTextEditorProps, State> {
