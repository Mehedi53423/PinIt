...
let _$D = t => t,
    ...
    _t2$n,
    _t3$e;
const ROOT_STYLE = css(_t$E || (_t$E = _$D`
  &:not([hidden]) {
    display: flex;
  }
`));
...
function textBaseStyle(props) {
  ...
  `), $accent && css(_t2$m || (_t2$m = _$C`
      color: var(--card-accent-fg-color);
    `)), $muted && css(_t3$d || (_t3$d = _$C`
...
const SpanWithTextOverflow$2 = styled.span(_t$C || (_t$C = _$B`
  display: block;
  white-space: nowrap;
...
let _$z = t => t,
    _t$A;
const BASE_STYLES = css(_t$A || (_t$A = _$z`
  white-space: nowrap;
...
function labelBaseStyle(props) {
  ...
  `), $accent && css(_t2$l || (_t2$l = _$y`
      color: var(--card-accent-fg-color);
    `)), $muted && css(_t3$c || (_t3$c = _$y`
      color: var(--card-muted-fg-color);
    `)), fonts.code.family);
}
...
const SpanWithTextOverflow$1 = styled.span(_t$y || (_t$y = _$x`
  display: block;
  white-space: nowrap;
  text-overflow: ellipsis;
  overflow: hidden;
...
let _$w = t => t,
    _t$x,
    _t2$k;
const rotate$1 = keyframes(_t$x || (_t$x = _$w`
  from {
    transform: rotate(0deg);
  }
...
`));
const Root$w = styled(Text)(_t2$k || (_t2$k = _$w`
  & > span > svg {
...
const LoadingBox = styled.div(_t$v || (_t$v = _$u`
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
...
function headingBaseStyle(props) {
  ...
  `), $accent && css(_t2$h || (_t2$h = _$q`
      color: var(--card-accent-fg-color);
    `)), $muted && css(_t3$a || (_t3$a = _$q`
      color: var(--card-muted-fg-color);
...
const SpanWithTextOverflow = styled.span(_t$q || (_t$q = _$p`
  display: block;
  white-space: nowrap;
  text-overflow: ellipsis;
  overflow: hidden;
...
let _$n = t => t,
    _t$o;
const Root$m = styled.div(_t$o || (_t$o = _$n`
  position: relative;
`));
...
let _$m = t => t,
    _t$n;
const Root$l = styled.div(_t$n || (_t$n = _$m`
  display: block;
  width: 0;
  height: 0;
  position: absolute;
...
let _$l = t => t,
    _t$m,
    _t2$g;
const Root$k = styled.div(_t$m || (_t$m = _$l`
  position: relative;
`));
const ItemWrapper = styled.div(_t2$g || (_t2$g = _$l`
  position: absolute;
  left: 0;
  right: 0;
`));
...
let _$k = t => t,
    ...
    _t2$f,
    _t3$9;
const Root$j = styled.div(_t$l || (_t$l = _$k`
  position: absolute;
  pointer-events: none;
  width: 27px;
  height: 27px;
...
`));
const BorderPath = styled.path(_t2$f || (_t2$f = _$k`
  fill: var(--card-shadow-outline-color);
`));
const ShapePath = styled.path(_t3$9 || (_t3$9 = _$k`
...
function switchThumbStyles(props) {
  ...
  return css(_t5$3 || (_t5$3 = _$h`
    ...
    ${0}
  `), rem(trackPadding), rem(trackPadding), rem(size), rem(size), rem(size / 2), input.switch.transitionDurationMs, input.switch.transitionTimingFunction, checked && css(_t6$1 || (_t6$1 = _$h`
      transform: translate3d(${0}px, 0, 0);
    `), checkedOffset), $indeterminate && css(_t7 || (_t7 = _$h`
      transform: translate3d(${0}px, 0, 0);
    `), indeterminateOffset));
}
...
const InputRoot$1 = styled.span(_t$g || (_t$g = _$g`
  flex: 1;
  min-width: 0;
  display: block;
  position: relative;
...
const InputRoot = styled.span(_t$f || (_t$f = _$f`
  flex: 1;
  min-width: 0;
  display: block;
  position: relative;
...
const LeftBox = styled(Box)(_t4$3 || (_t4$3 = _$f`
  position: absolute;
  top: 0;
  left: 0;
`));
const RightCard = styled(Card)(_t5$2 || (_t5$2 = _$f`
...
let _$e = t => t,
    ...
    _t2$9,
    _t3$4;
const Root$b = styled.div(_t$e || (_t$e = _$e`
  position: absolute;
  width: 15px;
  height: 15px;
  fill: none;
...
`));
const Border = styled.path(_t2$9 || (_t2$9 = _$e`
  fill: var(--card-shadow-outline-color);
`));
const Shape = styled.path(_t3$4 || (_t3$4 = _$e`
  fill: var(--card-bg-color);
`));
...
let _$d = t => t,
    _t$d;
const Root$a = styled(Layer)(_t$d || (_t$d = _$d`
  pointer-events: none;
`));
/**
 * @public
...
const Root$9 = styled.div(_t$c || (_t$c = _$c`
  /* position: relative; */
`));
/**
 * @internal
...
const ListBox = styled(Box)(_t2$8 || (_t2$8 = _$c`
  & > ul {
    list-style: none;
    padding: 0;
    margin: 0;
...
const ResultsPopover = styled(Popover)(_t3$3 || (_t3$3 = _$c`
  & > div {
    overflow: auto;
...
`));
const rotate = keyframes(_t4$2 || (_t4$2 = _$c`
  from {
    transform: rotate(0deg);
  }
...
const AnimatedSpinnerIcon = styled(SpinnerIcon)(_t5$1 || (_t5$1 = _$c`
  animation: ${0} 500ms linear infinite;
`), rotate);
...
let _$b = t => t,
    _t$b,
    _t2$7;
const Root$8 = styled.ol(_t$b || (_t$b = _$b`
  margin: 0;
  padding: 0;
  display: flex;
  list-style: none;
  ...
  line-height: 0;
`));
const ExpandButton = styled(Button)(_t2$7 || (_t2$7 = _$b`
  appearance: none;
  margin: -4px;
`));
...
const DialogContainer = styled(Container)(_t$a || (_t$a = _$a`
  &:not([hidden]) {
    display: flex;
  }
  width: 100%;
  ...
  justify-content: center;
`));
const DialogCardRoot = styled(Card)(_t2$6 || (_t2$6 = _$a`
  &:not([hidden]) {
    display: flex;
  }
  width: 100%;
  ...
  overflow: hidden;
`));
const DialogLayout = styled(Flex)(_t3$2 || (_t3$2 = _$a`
  flex: 1;
  min-height: 0;
  width: 100%;
`));
const DialogHeader = styled(Card)(_t4$1 || (_t4$1 = _$a`
  position: relative;
  z-index: 2;
...
`));
const DialogContent = styled(Box)(_t5 || (_t5 = _$a`
  position: relative;
  z-index: 1;
  overflow: auto;
  outline: none;
`));
const DialogFooter = styled(Box)(_t6 || (_t6 = _$a`
  position: relative;
  z-index: 3;
...
let _$9 = t => t,
    _t$9,
    _t2$5;
const Root$6 = styled.kbd(_t$9 || (_t$9 = _$9`
  &:not([hidden]) {
    display: block;
  }
  font: inherit;
`));
const Key = styled(KBD)(_t2$5 || (_t2$5 = _$9`
  &:not([hidden]) {
    display: block;
  }
`));
...
const MenuDivider = styled.hr(_t$7 || (_t$7 = _$7`
  height: 1px;
  border: 0;
...
function MenuGroup(props) {
  ...
  const active = Boolean(activeElement) && activeElement === rootElement; // const selected = active || open
