...
export declare function useCheckCondition(checkProperty: ConditionalProperty, checkPropertyName: string, { document, parent, value, currentUser }: ConditionalPropertyCallbackContext): boolean;
declare type ChildrenWithPropsProps = {
    children: React.ReactNode | React.ReactNode[];
    childProps: Record<string, unknown>;
};
export declare function mappedChildren({ children, childProps }: ChildrenWithPropsProps): {}[];
export {};
