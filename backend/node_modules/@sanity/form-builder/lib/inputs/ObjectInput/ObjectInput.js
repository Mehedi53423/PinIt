...
var ObjectInput = /*#__PURE__*/(0, _react.memo)( /*#__PURE__*/(0, _react.forwardRef)(function ObjectInput(props, forwardedRef) {
  ...
  var renderFields = (0, _react.useCallback)(() => {
    ...
    return type.fieldsets.map((fieldset, fieldsetIndex) => {
      ...
      fieldset.fields.map((field, fieldIndex) => renderField(field, level + 2, fieldsetIndex + fieldIndex, fieldset.readOnly, fieldSetValuesObject)));
    });
  }, [focusPath, level, markers, onFocus, presence, renderField, type.fields, type.fieldsets, value]);
