...
var ObjectInputField = /*#__PURE__*/(0, _react.forwardRef)(function ObjectInputField(props, forwardedRef) {
  ...
  var handleChange = (0, _react.useCallback)(event => {
    var isReadOnly = readOnly !== null && readOnly !== void 0 ? readOnly : field.type.readOnly;
  ...
  }, [isValueCompatible, compareValue, field.type, fieldPath, filterField, focusPath, forwardedRef, handleChange, level, markers, onBlur, onFocus, presence, value, readOnly]);
