...
class ArrayInput extends _react.default.Component {
  constructor() {
    ...
    _defineProperty(this, "handleFocusItem", item => {
      this.props.onFocus([{
        _key: item._key
      }, _paths.FOCUS_TERMINATOR]); // this.props.onFocus([{_key: item._key}, item._type === 'reference' ? '_ref' : FOCUS_TERMINATOR])
    });
  ...
  removeItem(item) {
    var _this$props5 = this.props,
        ...
        value = _this$props5.value; // create a patch for removing the item
  ...
  render() {
    var _this$props6 = this.props,
        ...
        ReferenceItemComponent = _this$props6.ReferenceItemComponent,
