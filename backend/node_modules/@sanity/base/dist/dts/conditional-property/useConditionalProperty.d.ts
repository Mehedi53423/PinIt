...
export declare const unstable_useConditionalProperty: ({ checkProperty, ...props }: ConditionalPropertyProps) => boolean;
//# sourceMappingURL=useConditionalProperty.d.ts.map