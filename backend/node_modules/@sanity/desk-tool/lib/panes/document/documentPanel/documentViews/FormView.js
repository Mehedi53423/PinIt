...
function FormView(props) {
  ...
  (0, _react.useEffect)(() => {
    ...
    var sub = _filterFieldsFn.default.subscribe(nextFilterField => setState({
      filterField: nextFilterField
    }));
  ...
  }, [compareValue, documentSchema, filterField, focusPath, handleBlur, handleChange, handleFocus, hasTypeMismatch, margins, markers, patchChannelRef, presence, ready, isReadOnly, value]);
