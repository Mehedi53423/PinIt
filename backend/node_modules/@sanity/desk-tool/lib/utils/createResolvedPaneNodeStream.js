...
function resolvePaneTree(_ref) {
  ...
  try {
    ...
    if (e instanceof _PaneResolutionError.PaneResolutionError) {
      if (e.context) {
        console.warn("Pane resolution error at index ".concat(e.context.index).concat(e.context.splitIndex > 0 ? " for split pane index ".concat(e.context.splitIndex) : '', ": ").concat(e.message).concat(e.helpId ? " - see ".concat((0, _generateHelpUrl.default)(e.helpId)) : ''), e);
      }
