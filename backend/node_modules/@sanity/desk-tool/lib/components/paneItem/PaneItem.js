...
var PaneItemCard = (0, _styledComponents.default)(_ui.Card)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  /* TextWithTone uses its own logic to set color, and we therefore need \n  to override this logic in order to set the correct color in different states */\n  &[data-selected],\n  &[data-pressed],\n  &:active {\n    [data-ui='TextWithTone'] {\n      color: inherit;\n    }\n  }\n"])));
...
function PaneItem(props) {
  ...
  return (0, _react.useMemo)(() => /*#__PURE__*/_react.default.createElement(PaneItemCard, {
