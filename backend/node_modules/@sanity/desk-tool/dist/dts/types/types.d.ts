...
declare type MenuItem = ReturnType<ReturnType<typeof StructureBuilder.menuItem>['serialize']>;
/**
...
export interface CustomComponentPaneNode<Props extends CustomComponentPaneNodeProps = CustomComponentPaneNodeProps> extends BaseResolvedPaneNode<'component'> {
...
export declare type PaneView<TOptions = unknown> = {
    id: string;
    type: 'form';
    title: string;
